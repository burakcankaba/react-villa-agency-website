            ...
            <div className="headerContainer">
                ...
                <div className="headerSearch">
                    ...
                    <div className="headerSearchItem">
                        ...
                        <label onClick={() => setOpenDestModal(!openDestModal)}>{selectedCity ? selectedCity : "Tour Places"}</label>
                        {
                    ...
                    <div className="headerSearchItem">
                        <BiCurrentLocation className="headerIcon" />
                        <label onClick={() => setOpenToModal(!openToModal)}>{selectedToCity ? selectedToCity : "Tour Categories"}</label>
                        {
                    ...
                    <div className="headerSearchItem">
                        ...
                        <input type="date" onChange={handleChange} defaultValue={today} />
                    </div>
